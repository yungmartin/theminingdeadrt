...
public class Barrett implements Listener {
    ...
    public void shoot(PlayerInteractEvent e) {
        ...
        if (e.getAction().equals(Action.RIGHT_CLICK_AIR) || e.getAction().equals(Action.RIGHT_CLICK_BLOCK)) {
            if (shooter.getInventory().getItemInHand().getType().equals(Material.STONE_AXE)) {
    ...
    public void reload(PlayerDropItemEvent e){
        ...
        if(e.getItemDrop().getItemStack().getType().equals(Material.STONE_AXE)){
                    ...
                    if(!reload.contains(player)){
                        ...
                        new BukkitRunnable(){
                            ...
                            public void run() {
                                ...
                                if(reload.contains(player) && player.getItemInHand().getType().equals(Material.STONE_AXE)){
                                    if(reloadTime <= 0.1){
    ...
    public void scope(PlayerToggleSneakEvent e){
        ...
        if(player.getItemInHand().getType().equals(Material.STONE_AXE) && !player.isSneaking()){
        ...
        if(player.getItemInHand().getType().equals(Material.STONE_AXE) && player.isSneaking() && scope.contains(player)){
    ...
    public void displayGunAmmoOnEquip(PlayerItemHeldEvent e){
        ...
        if(player.getInventory().getItem(e.getNewSlot()) != null) {
            ...
            if (player.getInventory().getItem(e.getNewSlot()).getType().equals(Material.STONE_AXE)) {
                if (gun.hasKey("ammo")) {
